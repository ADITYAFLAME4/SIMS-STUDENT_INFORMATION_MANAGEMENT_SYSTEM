...
$password=$_POST['password'];
  ...
  $dateCreated = date("Y-m-d");
    ...
    $query=mysqli_query($conn,"insert into tblstudents(st_img,firstName,lastName,emailAddress,admissionNumber,fname,mname,gender,mobile,religion,dob,address,session,semister,library,cgpa,fees,state,police,exam,ctype,notice,password,classId,classArmId,dateCreated) 
    value('$folder','$firstName','$lastName','$emailAddress','$admissionNumber','$fname','$mname','$gender','$mobile','$religion','$address','$dob','$session','$semister',
                  ...
                  <form method="post" enctype="multipart/form-data">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                      ...
                      <input type="number" class="form-control" required name="session" value="<?php echo $row['session'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
