					...
					<div class="card-body" style="overflow-x:auto;">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$fees = $conn->query("SELECT ef.*,s.firstName as sname,s.lastName,s.admissionNumber FROM student_ef_list ef inner join tblstudents s on s.id = ef.student_id order by s.firstName asc ");
