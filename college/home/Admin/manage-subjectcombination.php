...
<?php include('includes1/leftbar.php');?>  
                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT tblclassarms.classId,tblclassarms.classArmName,tblsubjects.SubjectName,tblsubjectcombination.id as scid,tblsubjectcombination.status from tblsubjectcombination join tblclassarms on tblclassarms.id=tblsubjectcombination.ClassId  join tblsubjects on tblsubjects.id=tblsubjectcombination.SubjectId";
$query = $dbh->prepare($sql);
$query->execute();
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
                                                            <td><?php echo htmlentities($result->classId);?> &nbsp; .<?php echo htmlentities($result->classArmName);?></td>
