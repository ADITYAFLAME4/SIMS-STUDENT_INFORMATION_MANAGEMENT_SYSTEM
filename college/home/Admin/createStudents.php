 ...
 $police=$_POST['police'];
  ...
  $dateCreated = date("Y-m-d");
    ...
    if($ret > 0){ 
        ...
        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>This ID Address Already Exists!</div>";
    }
    else{

    $query=mysqli_query($conn,"insert into tblstudents(st_img,fee,firstName,lastName,emailAddress,admissionNumber,fname,mname,gender,mobile,religion,dob,address,session,semister,library,cgpa,fees,state,police,exam,ctype,notice,password,classId,classArmId,dateCreated) 
    value('$folder','$folder','$firstName','$lastName','$emailAddress','$admissionNumber','$fname','$mname','$gender','$mobile','$religion','$address','$dob','$session','$semister',
    '$library','$cgpa','$fees','$state','$police','$exam','$ctype','$notice','$password','$classId','$classArmId','$dateCreated')");
    if ($query) {
...
//--------------------EDIT------------------------------------------------------------
 ...
 ,password='$password', classId='$classId',classArmId='$classArmId'
   where Id='$Id' ");
            if ($query) {
                   ...
                   <div class="col-xl-6">
                     ...
                     <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" required name="fname" value="<?php echo $row['fname'];?>" id="exampleInputFirstName" >
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Mother Name<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" required name="mname" value="<?php echo $row['mname'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Gender<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" required name="gender" value="<?php echo $row['gender'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                      ...
                      <input type="number" class="form-control" required name="mobile" value="<?php echo $row['mobile'];?>" id="exampleInputFirstName" >
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Religion<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" required name="religion" value="<?php echo $row['religion'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                      ...
                      <input type="date" class="form-control" required name="dob" value="<?php echo $row['dob'];?>" id="exampleInputFirstName" >
                        </div>
                      
                        
                        <div class="col-xl-6">
                        <label class="form-control-label">Semister<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" required name="semister" value="<?php echo $row['semister'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Library Id<span class="text-danger ml-2"></span></label>
                      <input type="text" class="form-control"  name="library" value="<?php echo $row['library'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">CGPA LAST<span class="text-danger ml-2"></span></label>
                      <input type="text" class="form-control" name="cgpa" value="<?php echo $row['cgpa'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Fees Due<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" required name="fees" value="<?php echo $row['fees'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">State <span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control"  name="state" value="<?php echo $row['state'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Area police Station<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" required name="police" value="<?php echo $row['police'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Last Passed Exam(%)<span class="text-danger ml-2">*</span></label>
                      <input type="number" class="form-control" required name="exam" value="<?php echo $row['exam'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Course Type<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" required name="ctype" value="<?php echo $row['ctype'];?>" id="exampleInputFirstName" >
                        </div>
                        <div class="col-xl-6">
                        <label class="form-control-label">Notice<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control"  name="notice" value="<?php echo $row['notice'];?>" id="exampleInputFirstName" >
                        </div>
                    ...
                    <div class="col-xl-6">
                        ...
                        $num = $result->num_rows;		
                        if ($num > 0){
                          echo ' <select required name="session" >';
