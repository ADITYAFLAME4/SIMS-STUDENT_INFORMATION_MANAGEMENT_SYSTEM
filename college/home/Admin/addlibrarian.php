...
if(isset($_POST['save'])){
  ...
  $password=$_POST['password'];
    ...
    $query=mysqli_query($conn,"select * from librarian where emailAddress ='$emailAddress'");
    ...
    $query=mysqli_query($conn,"INSERT into librarian(firstName,lastName,emailAddress,password) 
...
//--------------------EDIT------------------------------------------------------------
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
    ...
    $query=mysqli_query($conn,"update librarian set firstName='$firstName', lastName='$lastName',
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper" style="background:linear-gradient(45deg ,red,white,blue);">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Create Librarian </h1>
            <ol class="breadcrumb">
