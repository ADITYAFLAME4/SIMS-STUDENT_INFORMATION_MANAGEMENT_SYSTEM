            ...
            <div class="col-md-12" style="overflow-x:auto;">
                <table class="table table-bordered" id='report-list'>
                    ...
                    <tbody>
                      ...
                      $i = 1;
                      $total = 0;
                      $payments = $conn->query("SELECT p.*,s.firstName as sname,s.lastName, ef.ef_no,s.admissionNumber FROM payments p inner join student_ef_list ef on ef.id = p.ef_id inner join tblstudents s on s.id = ef.student_id where date_format(p.date_created,'%Y-%m') = '$month' order by unix_timestamp(p.date_created) asc ");
