      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper" >
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800" style="font-family:aljerian ;">Administrator Dashboard</h1>
            <ol class="breadcrumb">
...
?>
            ...
            $termonly = mysqli_num_rows($query1);
            ?>
                        <div class="col-xl-3 col-md-6 mb-4"><a href="addlibrarian.php">
                          <div class="card h-100" style="background:linear-gradient(45deg,#ffe6e6;,white);">
                            <div class="card-body">
                              <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                  <div class="text-xs font-weight-bold text-uppercase mb-1">Librarian</div>
                                  <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $termonly;?></div>
                                  <div class="mt-2 mb-0 text-muted text-xs">
                                    <!-- <span class="text-success mr-2"><i class="fas fa-arrow-up"></i> 12%</span>
                                    <span>Since last years</span> -->
