	...
	<form id="manage-payment">
		...
		<div class="form-group">
			...
			<select name="ef_id" id="ef_id" class="custom-select input-sm select2">
				<option value=""></option>
				<?php
					$fees = $conn->query("SELECT ef.*,s.firstName as sname,s.admissionNumber FROM student_ef_list ef inner join tblstudents s on s.id = ef.student_id order by s.firstName asc ");
