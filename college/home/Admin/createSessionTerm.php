    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper" style="background:linear-gradient(45deg ,white,white,white);">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"style="font-family:aljerian ;" >Create Session and Term</h1>
            <ol class="breadcrumb">
