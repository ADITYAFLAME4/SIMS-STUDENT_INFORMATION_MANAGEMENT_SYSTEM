...
if(isset($_POST['save'])){
    ...
    $password=$_POST['password'];
        ...
        $query=mysqli_query($conn,"insert into librarian(firstName,emailAddress,password) value('$firstName','$emailAddress','$password')");
 ...
 if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit")
	{
        ...
        $query=mysqli_query($conn,"select * from librarian where Id ='$Id'");
        ...
        if(isset($_POST['update'])){
           ...
           ;
            ...
            $query=mysqli_query($conn,"update librarian set firstName='$firstName' , emailAddress='$emailAddress',password='$password' where Id='$Id'");
  ...
  if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "delete")
	{
        ...
        $query = mysqli_query($conn,"DELETE FROM librarian WHERE Id='$Id'");
       ...
       <?php include "Includes/topbar.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4" style="background:linear-gradient(white,#ffe6e6,white); >
            <h1 class="h3 mb-0 text-gray-800">Add Librarians</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">All Librarian</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12" style="background:linear-gradient(45deg ,#f0eaea,white,#f0eaea); ">
              ...
              <div class="card mb-4" style="background:linear-gradient(white,white;,#e4e0e0);">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Create All Librarian</h6>
                    <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
              ...
              <div class="card mb-4" style="background:linear-gradient(white,white); ">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">All Librarian</h6>
                </div>
