...
<?php $sql = "SELECT * from tblclassarms";
$query = $dbh->prepare($sql);
$query->execute();
...
{   ?>
<option value="<?php echo htmlentities($result->Id); ?>"><?php echo htmlentities($result->classId); ?>&nbsp; .<?php echo htmlentities($result->classArmName); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
